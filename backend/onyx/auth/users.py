...
class UserManager(UUIDIDMixin, BaseUserManager[User, uuid.UUID]):
    ...
    async def create(
        ...
        # registration, single-tenant BASIC only. Only fastapi-users' untrusted
        # register route passes safe=True. SAML/JWT provisioning uses the default
    ...
    async def authenticate(
        ...
        # everyone, single-tenant BASIC only (this runs before the user's tenant
